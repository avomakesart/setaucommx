...
export const metadata: Metadata = {
  title: "Articulo | SETAU",
  description: "Lee nuestro articulo que tenemos publicados.",
};
                  ...
                  <div className="flex flex-col gap-8 md:gap-12">
                    ...
                    <div className="w-full">
                      <p>
                        ...
                        thriving businesses from those that struggle. By
                        building financial and operational resilience, companies
                        can safeguard their future and seize new opportunities.
                      </p>
                    </div>
                  </div>
